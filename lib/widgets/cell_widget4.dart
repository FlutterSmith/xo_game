...
class CellWidget4 extends StatefulWidget {
  final int index;
  final String value;
  ...
  @override
  State<CellWidget4> createState() => _CellWidget4State();
}

class _CellWidget4State extends State<CellWidget4> with SingleTickerProviderStateMixin {
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: widget.value.isEmpty
                            ...
                            : AnimatedMark(mark: widget.value, markSize: 50),
                      ),
                    ),
                  ),
                ),
